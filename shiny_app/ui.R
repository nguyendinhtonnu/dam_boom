    ...
    navbarPage(
      "Population and Disasters in Asian River Delta",
               ...
               tabPanel(
                 "Data",
                 sidebarLayout(
                   sidebarPanel("Some river disasters in Asia: Data from EM-DAT",
                                p("Filtering data from EM-DAT database to only show riverine disasters that results in burst dams or dikes. The frequency of disaster is shown by the size of the point. The plot shows data from 1990 to 2015.")),
                   mainPanel(
